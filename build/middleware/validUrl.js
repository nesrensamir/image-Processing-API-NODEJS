...
var logger = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var rFileName, rWidth, rHeight, srcFilePath, dstFileName, dstDir, dstFilePath;
        ...
        switch (_a.label) {
            case 0:
                if (req.query.filename === undefined ||
                    ...
                    res.send("Error: Please enter valid URL parameters");
                    return [2 /*return*/];
                }
                rFileName = req.query.filename;
                rWidth = parseInt(req.query.width);
                rHeight = parseInt(req.query.height);
                if (isNaN(rWidth) || isNaN(rHeight)) {
                    res.send("Error: Please enter valid number for width and height");
                    return [2 /*return*/];
                }
                srcFilePath = path_1.default.join(__dirname + '../../../images/full/' + rFileName + '.jpg');
                dstFileName = rFileName + rWidth + rHeight + '.jpg';
                dstDir = path_1.default.join(__dirname + '../../../images/thumbnails/');
                ...
                //call resize fn  
                return [4 /*yield*/, (0, resize_1.default)(srcFilePath, rWidth, rHeight, dstFilePath)];
            case 1:
                //call resize fn  
                _a.sent();
                res.sendFile(dstFilePath);
